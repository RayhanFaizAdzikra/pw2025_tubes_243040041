<?php
    ...
    $query = mysqli_query($conn, "SELECT a.*, b.nama AS nama_kategori FROM dokter a JOIN kategori b ON a.kategori_id=b.id");
         ...
         <div class="table-responsive mt-4">
            <table class="table">
                ...
                <tbody>
                    ...
                    ?>
                         <tr>
                            <td colspan=6 class="text-center">Data Doctor Tidak Tersedia</td>
                        </tr>
                    <?php
                     }
                     else {
